...
public class DepositDto {
    ...
    private DepositDto.Result result;
    @Autowired
    ...
    public static class Result {
        private List<DepositDto.Optionlist> optionList;
        private List<DepositDto.Baselist> baseList;
    ...
    public DepositEntity toEntity() {
        ...
        return DepositEntity.builder()
                ...
                .options(result.getOptionList().stream().map(new Function<DepositDto.Optionlist, DepositOptionEntity>() {

                    @Override
                    public DepositOptionEntity apply(DepositDto.Optionlist t) {
                        DepositOptionEntity tempEntity = new DepositOptionEntity();
                        tempEntity = modelMapper.map(t, DepositOptionEntity.class);
                        return tempEntity;
                    }
